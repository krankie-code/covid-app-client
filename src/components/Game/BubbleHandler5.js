...
export class BubbleHandler5 extends Component {
    constructor(props){
      super(props)
    ...
    render() {
      ...
      return isRunning ? (
        ...
        <Bubble5 stopCounter = {this.stopCounter} style={this.state.position} stopGame = {this.props.stopGame} />
